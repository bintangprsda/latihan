    ...
    <div className="flex flex-col rounded-lg border border-gray-200/80 bg-white p-4 sm:flex-row">
      ...
      <div className="relative mb-4 sm:mb-0 sm:mr-4">
        ...
        <img
          ...
          alt="User"
          style={{ maxWidth: "170px", maxHeight: "170px" }} // Atur lebar maksimum dan tinggi maksimum sesuai keinginan
        />

        {/* Online Status Dot */}
        <div
          className="absolute -right-3 bottom-5 h-5 w-5 sm:top-2 rounded-full border-4 border-white bg-green-400 sm:hidden md:block"
